...
//constexpr int BOOL_OPTION_ORIGIN = OPT_FORCE_YN;
//constexpr int INT_OPTION_ORIGIN = OPT_FONT_HEIGHT;
constexpr int STR_OPTION_ORIGIN = OPT_FONT;
constexpr int MAX_OPTIONS = OPT_FONTPATH + 1;
