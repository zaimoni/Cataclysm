...
{
 SET_VECTOR(mapitems[mi_field], itm_rock, itm_strawberries);

 SET_VECTOR(mapitems[mi_forest],
	itm_rock, itm_stick, itm_mushroom, itm_mushroom_poison,
	itm_mushroom_magic, itm_blueberries);

 SET_VECTOR(mapitems[mi_hive], itm_honeycomb);
 SET_VECTOR(mapitems[mi_hive_center], itm_honeycomb, itm_royal_jelly);

 SET_VECTOR(mapitems[mi_road],
	itm_muffler, itm_pipe, itm_motor, itm_wheel, itm_big_wheel, itm_seat, 
    itm_combustion_small, itm_combustion);

 SET_VECTOR(mapitems[mi_livingroom],
 ...
 SET_VECTOR(mapitems[mi_kitchen],
 ...
 SET_VECTOR(mapitems[mi_home_hw],
 ...
 SET_VECTOR(mapitems[mi_bedroom],
 ...
 SET_VECTOR(mapitems[mi_homeguns],
 ...
 SET_VECTOR(mapitems[mi_dresser],
 ...
 SET_VECTOR(mapitems[mi_cannedfood],
 ...
 SET_VECTOR(mapitems[mi_hardware],
 ...
 SET_VECTOR(mapitems[mi_consumer_electronics],
 ...
 SET_VECTOR(mapitems[mi_sports],
	...
	itm_helmet_ball, itm_manual_brawl);

 SET_VECTOR(mapitems[mi_camping],
 ...
 SET_VECTOR(mapitems[mi_allsporting],
 ...
 SET_VECTOR(mapitems[mi_alcohol], itm_whiskey, itm_vodka, itm_rum, itm_tequila);
 SET_VECTOR(mapitems[mi_pool_table], itm_pool_cue, itm_pool_ball);

 SET_VECTOR(mapitems[mi_trash],
 ...
 SET_VECTOR(mapitems[mi_pistols],
 ...
 SET_VECTOR(mapitems[mi_gunxtras],
 ...
 SET_VECTOR(mapitems[mi_bags], itm_backpack, itm_purse, itm_mbag);

 SET_VECTOR(mapitems[mi_allclothes],
	...
	itm_hat_fur, itm_UPS_off);

 SET_VECTOR(mapitems[mi_novels],
	itm_novel_romance, itm_novel_spy, itm_novel_scifi, itm_novel_drama);

 SET_VECTOR(mapitems[mi_manuals],
 ...
 SET_VECTOR(mapitems[mi_textbooks],
 ...
 SET_VECTOR(mapitems[mi_cop_weapons],
 ...
 SET_VECTOR(mapitems[mi_cop_evidence],
 ...
 SET_VECTOR(mapitems[mi_hospital_lab],
 ...
 SET_VECTOR(mapitems[mi_hospital_samples],
	itm_blood, itm_vacutainer);

 SET_VECTOR(mapitems[mi_surgery],
	itm_blood, itm_iodine, itm_bandages, itm_scalpel, itm_syringe,
	itm_gloves_medical, itm_mask_dust, itm_vacutainer);

 SET_VECTOR(mapitems[mi_office],
 ...
 SET_VECTOR(mapitems[mi_mil_surplus], // NOT food or armor!
	...
	itm_geiger_off, itm_usb_drive);

 SET_VECTOR(mapitems[mi_shelter],
 ...
 SET_VECTOR(mapitems[mi_chemistry],
 ...
 SET_VECTOR(mapitems[mi_hydro],
	itm_blueberries, itm_strawberries, itm_tomato, itm_broccoli,
	itm_zucchini, itm_potato_raw);

 SET_VECTOR(mapitems[mi_electronics],
	...
	itm_usb_drive, itm_software_useless, itm_solar_panel);

 SET_VECTOR(mapitems[mi_monparts],
	itm_meat, itm_veggy, itm_meat_tainted, itm_veggy_tainted,
	itm_royal_jelly, itm_ant_egg, itm_bee_sting, itm_chitin_piece);

 SET_VECTOR(mapitems[mi_bionics],
 ...
 SET_VECTOR(mapitems[mi_bionics_common],
	itm_bionics_battery, itm_bionics_power, itm_bionics_tools);

 SET_VECTOR(mapitems[mi_bots], itm_bot_manhack, itm_bot_turret);

 SET_VECTOR(mapitems[mi_launchers],
 ...
 SET_VECTOR(mapitems[mi_mil_rifles],
 ...
 SET_VECTOR(mapitems[mi_weapons],
	...
	itm_baton, itm_tazer, itm_rapier);

 SET_VECTOR(mapitems[mi_survival_armor],
 ...
 SET_VECTOR(mapitems[mi_survival_tools],
 ...
 SET_VECTOR(mapitems[mi_sewage_plant],
	...
	itm_bionics_tools, itm_bionics_hazmat);

 SET_VECTOR(mapitems[mi_mine_storage], itm_rock, itm_coal);

 SET_VECTOR(mapitems[mi_mine_equipment],
 ...
 SET_VECTOR(mapitems[mi_spiral], itm_spiral_stone, itm_vortex_stone);

 SET_VECTOR(mapitems[mi_radio],
 ...
 SET_VECTOR(mapitems[mi_toxic_dump_equipment],
 ...
 SET_VECTOR(mapitems[mi_sewer],
	itm_mutagen, itm_fetus, itm_weed, itm_mag_porn, itm_rag);

 SET_VECTOR(mapitems[mi_cavern],
	itm_rock, itm_jackhammer, itm_flashlight, itm_dynamite);

 SET_VECTOR(mapitems[mi_spider],
 ...
 SET_VECTOR(mapitems[mi_ant_food],
 ...
 SET_VECTOR(mapitems[mi_ant_egg], itm_ant_egg);	//TODO: More items here?
 SET_VECTOR(mapitems[mi_biollante], itm_biollante_bud);
 SET_VECTOR(mapitems[mi_bugs], itm_chitin_piece);
 SET_VECTOR(mapitems[mi_bees], itm_bee_sting, itm_chitin_piece);
 SET_VECTOR(mapitems[mi_wasps], itm_wasp_sting, itm_chitin_piece);

 SET_VECTOR(mapitems[mi_robots],
	itm_processor, itm_RAM, itm_power_supply, itm_amplifier,
	itm_transponder, itm_receiver, itm_antenna, itm_steel_chunk,
	itm_steel_lump, itm_motor, itm_battery, itm_plut_cell);

 SET_VECTOR(mapitems[mi_helicopter],
	...
	itm_two_way_radio, itm_radio, itm_UPS_off);

// TODO: Replace kevlar with the ceramic plate armor
 SET_VECTOR(mapitems[mi_military],
 ...
 SET_VECTOR(mapitems[mi_science],
 ...
 SET_VECTOR(mapitems[mi_rare],
	...
	itm_plasma, itm_plasma_rifle);

 SET_VECTOR(mapitems[mi_stash_food],
	itm_water, itm_cola, itm_jerky, itm_ravioli, itm_can_beans,
	itm_can_corn, itm_can_spam);

 SET_VECTOR(mapitems[mi_stash_ammo],
	...
	itm_762_m87, itm_556, itm_3006, itm_762_51, itm_arrow_cf);

 SET_VECTOR(mapitems[mi_stash_wood], itm_stick, itm_ax, itm_saw, itm_2x4);

 SET_VECTOR(mapitems[mi_stash_drugs],
	itm_pills_sleep, itm_oxycodone, itm_xanax, itm_adderall, itm_weed,
	itm_coke, itm_meth, itm_heroin);

 SET_VECTOR(mapitems[mi_drugdealer],
