...
{   // name        sym   color    sym_b   color_b  dmg  dur  par1 par2  item
	{ "null part",  '?', c_red,     '?', c_red,     100, 100, 0, AT_NULL, itm_null, 0, 0 },
{ "seat",       '#', c_red,     '*', c_red,     60,  300, 0, AT_NULL, itm_seat, 1,
mfb(vpf_over) | mfb(vpf_seat) | mfb(vpf_no_reinforce) },
{ "frame",      'h', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "frame",      'j', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "frame",      'c', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "frame",      'y', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "frame",      'u', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "frame",      'n', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "frame",      'b', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "frame",      '=', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "frame",      'H', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "frame",      '^', c_ltgray,  '#', c_ltgray,  100, 400, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "handle",     '^', c_ltcyan,  '#', c_ltcyan,  100, 300, 0, AT_NULL, itm_frame, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) },
{ "board",      'h', c_ltgray,  '#', c_ltgray,  100, 1000, 0, AT_NULL, itm_steel_plate, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) | mfb(vpf_opaque) | mfb(vpf_obstacle) },
{ "board",      'j', c_ltgray,  '#', c_ltgray,  100, 1000, 0, AT_NULL, itm_steel_plate, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) | mfb(vpf_opaque) | mfb(vpf_obstacle) },
{ "board",      'y', c_ltgray,  '#', c_ltgray,  100, 1000, 0, AT_NULL, itm_steel_plate, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) | mfb(vpf_opaque) | mfb(vpf_obstacle) },
{ "board",      'u', c_ltgray,  '#', c_ltgray,  100, 1000, 0, AT_NULL, itm_steel_plate, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) | mfb(vpf_opaque) | mfb(vpf_obstacle) },
{ "board",      'n', c_ltgray,  '#', c_ltgray,  100, 1000, 0, AT_NULL, itm_steel_plate, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) | mfb(vpf_opaque) | mfb(vpf_obstacle) },
{ "board",      'b', c_ltgray,  '#', c_ltgray,  100, 1000, 0, AT_NULL, itm_steel_plate, 1,
mfb(vpf_external) | mfb(vpf_mount_point) | mfb(vpf_mount_inner) | mfb(vpf_opaque) | mfb(vpf_obstacle) },
{ "roof",       '#', c_ltgray,  '#', c_dkgray,  100, 1000, 0, AT_NULL, itm_steel_plate, 1,
mfb(vpf_internal) | mfb(vpf_roof) },
{ "door",       '+', c_cyan,    '&', c_cyan,    80,  200, 0, AT_NULL, itm_frame, 2,
mfb(vpf_external) | mfb(vpf_obstacle) | mfb(vpf_openable) },
{ "windshield", '"', c_ltcyan,  '0', c_ltgray,  70,  50, 0, AT_NULL, itm_glass_sheet, 1,
mfb(vpf_over) | mfb(vpf_obstacle) | mfb(vpf_no_reinforce) },
{ "blade",      '-', c_white,   'x', c_white,   250, 100, 0, AT_NULL, itm_machete, 2,
mfb(vpf_external) | mfb(vpf_unmount_on_damage) | mfb(vpf_sharp) | mfb(vpf_no_reinforce) },
{ "blade",      '|', c_white,   'x', c_white,   350, 100, 0, AT_NULL, itm_machete, 2,
mfb(vpf_external) | mfb(vpf_unmount_on_damage) | mfb(vpf_sharp) | mfb(vpf_no_reinforce) },
{ "spike",      '.', c_white,   'x', c_white,   300, 100, 0, AT_NULL, itm_spear_knife, 2,
mfb(vpf_external) | mfb(vpf_unmount_on_damage) | mfb(vpf_sharp) | mfb(vpf_no_reinforce) },

//                                                           size
{ "large wheel",'0', c_dkgray,  'x', c_ltgray,  50,  300, 30, AT_NULL, itm_big_wheel, 3,
mfb(vpf_external) | mfb(vpf_mount_over) | mfb(vpf_wheel) | mfb(vpf_mount_point) },
{ "wheel",      'o', c_dkgray,  'x', c_ltgray,  50,  200, 10, AT_NULL, itm_wheel, 2,
mfb(vpf_external) | mfb(vpf_mount_over) | mfb(vpf_wheel) | mfb(vpf_mount_point) },
//                                                                         power type
...
mfb(vpf_internal) | mfb(vpf_fuel_tank) },
{ "trunk",                      'H', c_brown,  '#', c_brown,    80, 300, 400, AT_NULL, itm_frame, 1,
mfb(vpf_over) | mfb(vpf_cargo) },
{ "box",                        'o', c_brown,  '#', c_brown,    60, 100, 400, AT_NULL, itm_frame, 1,
mfb(vpf_over) | mfb(vpf_cargo) },

{ "controls",   '$', c_ltgray,  '$', c_red,     10, 250, 0, AT_NULL, itm_vehicle_controls, 3,
mfb(vpf_internal) | mfb(vpf_controls) },
//                                                          bonus
{ "muffler",    '/', c_ltgray,  '/', c_ltgray,  10, 150, 40, AT_NULL, itm_muffler, 2,
mfb(vpf_internal) | mfb(vpf_muffler) },
{ "seatbelt",   ',', c_ltgray,  ',', c_red,     10, 200, 25, AT_NULL, itm_rope_6, 1,
mfb(vpf_internal) | mfb(vpf_seatbelt) },
{ "solar panel", '#', c_yellow,  'x', c_yellow, 10, 20, 30, AT_NULL, itm_solar_panel, 6,
...
{ "steel plating",     ')', c_ltcyan, ')', c_ltcyan, 100, 1000, 0, AT_NULL, itm_steel_plate, 3,
mfb(vpf_internal) | mfb(vpf_armor) },
{ "superalloy plating",')', c_dkgray, ')', c_dkgray, 100, 900, 0, AT_NULL, itm_alloy_plate, 4,
mfb(vpf_internal) | mfb(vpf_armor) },
{ "spiked plating",    ')', c_red,    ')', c_red,    150, 900, 0, AT_NULL, itm_spiked_plate, 3,
mfb(vpf_internal) | mfb(vpf_armor) | mfb(vpf_sharp) },
{ "hard plating",      ')', c_cyan,   ')', c_cyan,   100, 2300, 0, AT_NULL, itm_hard_plate, 4,
mfb(vpf_internal) | mfb(vpf_armor) }
};
