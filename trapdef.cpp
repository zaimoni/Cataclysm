...
//	Name			Symbol	Color		Vis Avd Diff
 traps.push_back(new trap(++id, "none", '?', c_white, 20, 0, 0, {}, {} TRAP_HANDLERS(nullptr, nullptr)));
 ...
 traps.push_back(new trap(++id, "rabbit snare", '\\', c_brown, 5, 10, 2, { itm_stick, itm_string_36 }, {} TRAP_HANDLERS(nullptr, nullptr))); // \todo implement ...::snare
 ...
 traps.push_back(new trap(++id, "spinning blade engine", '_', c_ltred, 0, 0, 2, { itm_motor, itm_machete, itm_machete }, {} TRAP_HANDLERS(nullptr, nullptr)));
 ...
 traps.push_back(new trap(++id, "sinkhole", '_', c_brown, 10, 14, 99, {}, {} TRAP_HANDLERS(&trapfunc::sinkhole, nullptr)));
 ...
 traps.push_back(new trap(++id, "shimmering portal", '%', c_magenta, 0, 30, 99, {}, {} TRAP_HANDLERS(nullptr, nullptr))); // \todo implement major game feature; ...::portal
 ...
 traps.push_back(new trap(++id, "raised tile", '^', c_ltgray, 9, 20, 99, {}, {} TRAP_HANDLERS(&trapfunc::temple_flood, nullptr)));
 // Toggles through states of RGB walls
 traps.push_back(new trap(++id, "", '^', c_white, 99, 99, 99, {}, {} TRAP_HANDLERS(&trapfunc::temple_toggle, nullptr)));
 ...
 traps.push_back(new trap(++id, "", '^', c_white, 99, 99, 99, {}, {} TRAP_HANDLERS(&trapfunc::shadow, nullptr))); // Shadow spawn
